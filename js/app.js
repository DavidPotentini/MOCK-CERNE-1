...
VIEWS.planejamento = () => {
  ...
  ${ed ? "": `<div class="note warn" style="margin-bottom:16px"><span>🔒</span><div><b>Ciclo encerrado — somente consulta.</b> O planejamento deste ciclo é <b>histórico preservado</b> e não recebe novos ajustes. Para editar, coloque o <b>ciclo ativo</b> em foco em <a href="#/incubadora">Minha Incubadora</a>.</div></div>`}
